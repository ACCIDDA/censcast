...
* observed admissions covering the `max_stay` window before the
  forecast (`hubData::connect_target_timeseries()`);
* a LOS distribution (`los_spec()`).
...
Without ground-truth census, LOS is the dominant assumption. Run
several specs and compare:
